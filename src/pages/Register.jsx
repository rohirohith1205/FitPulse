        ...
        <div className="space-y-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-500 text-lg max-w-sm">
              Join thousands of fitness professionals and start managing your gym today.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Grows with your business</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div>
                <h3 className="font-bold text-slate-900">Fully Automated</h3>
                <p className="text-sm text-slate-500">Focus on your clients</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center md:justify-end">
          <div className="bg-white p-10 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.08)] w-full max-w-md space-y-8">
            <div className="text-center space-y-2">
              ...
              <p className="text-slate-500 text-sm">Fill in the details to register your admin account</p>
            </div>
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  required
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                />
              </div>
            ...
            <p className="text-center text-sm text-slate-500">
              ...
              <Link to="/login" className="text-indigo-600 font-bold hover:text-indigo-500 underline-offset-4 hover:underline">
                Login
              </Link>
            </p>
          </div>
